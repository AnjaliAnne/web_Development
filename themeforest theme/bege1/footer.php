                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xl-9">
                                <div class="newsletter-text">
                                    ...
                                    <h4>..and Receive best quality laptops soon</h4>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3 col-md-3 col-xs-12 foo-pol">
                                <div class="footer-policy-box">
                                    ...
                                    <h3>Best quality laptops</h3>
                                    <p>Currently we are providing 30 days checking warrenty and service support.</p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3 col-md-3 col-xs-12 foo-pol">
                                <div class="footer-policy-box">
                                    ...
                                    <p>We really care about you and your Laptop as much as you do.</p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3 col-md-3 col-xs-12 foo-pol">
                                <div class="footer-policy-box">
                                    <p><i class="icon ion-android-plane"></i></p>
                                    <h3>All Kerala Shipping</h3>
                                    <p>Currently all over Kerala qualify for express international shipping.</p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3 col-md-3 col-xs-12 foo-pol">
                                <div class="footer-policy-box">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3 col-md-3 col-xs-12">
                                <div class="footer-logo-area">
                                    <a href="#"><img src="images/akhil/ecom_black.jpg" alt="footer logo"></a>
                                    <p>We are a small online store for the sales and service of used laptops and its accessories.</p>
                                    <ul>
                                        <li>
                                            <h4>Contact info:</h4>
                                            <p>E-computers, Calicut Road, Perinthalmanna.</p>
                                        </li>
                                        <li>
                                            <h4>Mobile No:</h4>
                                            <p>9061767778</p>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 col-lg-6 col-md-6">
                                <p>Copyright © 2020 ecomputers . All Rights Reserved.</p>
                            </div>
