                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
                                <div class="contact-address-area">
                                    <h2>CONTACT US</h2>
                                    <p>We are a small online store for the sales and service of used laptops and its accessories. We are here to hear and solve all your problems related to our store. we kindly requesting you to write your complaints here and we will reach you soon...</p>
                                    <ul>
                                        <li>
                                            <i class="fa fa-fax">&nbsp;</i> Address : E-computers, Calicut Road, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Perinthalmanna, Kerala, 679321</li>
                                        <li>
                                            <i class="fa fa-phone">&nbsp;</i> ecomputerspmna@gmail.com</li>
                                        <li>
                                            <i class="fa fa-envelope-o"></i>&nbsp;</i> 9061767778</li>
                                    </ul>
                                    <h3>
                                        <strong>Working hours</strong>
                                    </h3>
                                    <p>
                                        <strong>Monday – Saturday</strong>: &nbsp;09AM – 07PM</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            ...
            function init() {
                ...
                var mapOptions = {
                    ...
                    center: new google.maps.LatLng(10.976142, 76.211448), // New York
                ...
                var marker = new google.maps.Marker({
                    position: new google.maps.LatLng(10.976142, 76.211448),
                    map: map,
                    title: 'Snazzy!'
                });
            }
