        ...
        <div class="wrapper home-one single-product-page">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <nav class="woocommerce-breadcrumb">
                                ...
                                <span class="separator">/</span> seller Login
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <div class="entry-header">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h1 class="entry-title">Seller Login</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-6">
                                <div class="well mb-sm-30">
                                    <div class="new-customer">
                                        <h3 class="custom-title">customer</h3>
                                        <p class="mtb-10"><strong>Sign In</strong></p>
                                        <p>By signing in to your account you will be able to shop faster, be up to date on an order's status, and keep track of the orders you have previously made</p>
                            ...
                            <div class="col-md-6">
                                <div class="well">
                                    <div class="return-customer">
                                        <h3 class="mb-10 custom-title">Seller login</h3>
                                        <p class="mb-10"><strong>I am a product seller</strong></p>
                                        <form action="#">
