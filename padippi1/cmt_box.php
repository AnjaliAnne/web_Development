<div style="background: #f5f8fd; margin-top: 40px;">
...
<div class="zx">
      ...
      <?php
        ...
        if(!empty($comment) && !empty($name))
        {
          ...
          $date = date("Y-m-d");
          $r1 = "INSERT INTO `common_comment`(`name`, `comment`, `date`) VALUES ('$name', '$comment', '$date')";
          $w1 = mysqli_query($conn, $r1);
        }
        $r1 = "SELECT * FROM `common_comment` ORDER BY `id` DESC";
        $w1 = mysqli_query($conn, $r1);
