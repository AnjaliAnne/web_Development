...
<div class="container_fluid" style="min-height: 580px;">
    ...
    <?php
        if(isset($_POST['save']))
        {
            $id=$_POST['username'];
            $pass=$_POST['password'];
            if($id=='nadarstores1970@gmail.com')
            {                   
                if($pass=='nadar@123')
                { 
                    if($id =='nadarstores1970@gmail.com'&& $pass =='nadar@123')
                    {
                        $_SESSION['nadarstores1970@gmail.com']=$id;
                        ?>
                        <script> location.replace("sel.php"); </script>
                        <?php
                    }
                }
                else
