                    ...
                    <div class="row">
                                    ...
                                    <div class="form-group d-md-flex align-items-md-center">
                                        ...
                                        <div class="col-md-10">
                                            <select name="category">
                                                <option value="bh108">Vegitables</option>
                                                <option value="bk105">Fruits</option>
                                                <option value="bv104">Bakery</option>
                                                <option value="gr107">Beverages</option>
                                                <option value="hs101">Grocery</option>
                                                <option value="kt103">Cosmetics</option>
                                                <option value="pt106">Stationary</option>
                                                <option value="sf109">Pet Foods</option>
                                                <option value="vf102">HouseHolds</option>
                                            </select>
                                        </div>
                                    </div>
                                </fieldset>
                        ...
                        <?php
                         if(isset($_POST['fileuploadsubmit1'])){
                            $cat = $_POST['category'];
                            $db_name = "u798368486_padippiboy";
                            $mysql_username = "u798368486_padippiboy";
                            $mysql_password = "akhilaki322";
